...
$(".diceOld").click(function () {
    $(this).css({"display":"none"});
    $(this).next(".diceNew").css({"display":"block"})
})
$(".diceNew").click(function () {
    $(this).css({"display":"none"});
    $(this).prev(".diceOld").css({"display":"block"})
})
$(".douDiceOld").click(function () {
    $(this).css({"display":"none"});
    $(this).next(".douDiceNew").css({"display":"block"})
})
$(".douDiceNew").click(function () {
    $(this).css({"display":"none"});
    $(this).prev(".douDiceOld").css({"display":"block"})
})
$(".threeDiceOld").click(function () {
    $(this).css({"display":"none"});
    $(this).next(".threeDiceNew").css({"display":"block"})
})
$(".threeDiceNew").click(function () {
    $(this).css({"display":"none"});
    $(this).prev(".threeDiceOld").css({"display":"block"})
})
$(".selectAllOld1").click(function () {
    $(".selectAllOld1").css({"display":"none"});
    $(".selectAllNew1").css({"display":"block"})
})
$(".selectAllNew1").click(function () {
    $(".selectAllOld1").css({"display":"block"});
    $(".selectAllNew1").css({"display":"none"})
})
// $(".dice").click(function () {
//     if($(this).children(".diceOld").css("display"=="block")){
//         $(this).children(".diceOld").css({"display":"none"});
//         $(this).children(".diceNew").css({"display":"block"})
//     }else {
//         $(this).children(".diceOld").css({"display":"block"});
//         $(this).children(".diceNew").css({"display":"none"})
//     }
//
// })
