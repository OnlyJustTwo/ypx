...
$(".funNum").click(function () {
    ...
    if (!$(this).children("button").hasClass('bg-fangzi')){
        ...
        if($(this).parent("ul").hasClass('twonum')){
            $(".doublebtn").eq(i+4).css({"opacity":"0"})
        }else {
        ...
        // $(this).addClass("bg-wite")
        if($(this).parent("ul").hasClass('twonum')){
            $(".doublebtn").eq(i+4).css({"opacity":"1"})
        }else {
...
$(".doublebtn").click(function () {
    ...
    if($(this).css("opacity")=="1"){
        $(this).css({"opacity":"0"})
        if($(this).parent("div").hasClass('twoctrl')){
            $(".funnums").eq(i+4).addClass("bg-fangzi")
        }else {
            $(".funnums").eq(i).addClass("bg-fangzi")
        }
    }
})
$(".funNum1").click(function () {
    let i = $(this).index();
    // console.log(12312)
    if (!$(this).children("button").hasClass('bg-fangzi')){
        $(this).children("button").addClass("bg-fangzi")
        if($(this).parent("ul").hasClass('twonum')){
            $(".doublebtn1").eq(i+4).css({"opacity":"0"})
        }else {
            $(".doublebtn1").eq(i).css({"opacity":"0"})
        }
    }else {
        $(this).children("button").removeClass("bg-fangzi");
        // $(this).addClass("bg-wite")
        if($(this).parent("ul").hasClass('twonum')){
            $(".doublebtn1").eq(i+4).css({"opacity":"1"})
        }else {
            $(".doublebtn1").eq(i).css({"opacity":"1"})
        }

    }
});
$(".doublebtn1").click(function () {
    // console.log(12323)
    let i = $(this).index()
    if($(this).css("opacity")=="1"){
        $(this).css({"opacity":"0"})
        if($(this).parent("div").hasClass('twoctrl')){
            $(".funnums1").eq(i+4).addClass("bg-fangzi")
        }else {
            $(".funnums1").eq(i).addClass("bg-fangzi")
        }
    }
})
$(".funNum2").click(function () {
    let i = $(this).index();
    // console.log(12312)
    if (!$(this).children("button").hasClass('bg-fangzi')){
        $(this).children("button").addClass("bg-fangzi")
        if($(this).parent("ul").hasClass('twonum')){
            $(".doublebtn2").eq(i+4).css({"opacity":"0"})
        }else {
            $(".doublebtn2").eq(i).css({"opacity":"0"})
        }
    }else {
        $(this).children("button").removeClass("bg-fangzi");
        // $(this).addClass("bg-wite")
        if($(this).parent("ul").hasClass('twonum')){
            $(".doublebtn2").eq(i+4).css({"opacity":"1"})
        }else {
            $(".doublebtn2").eq(i).css({"opacity":"1"})
        }
...
$(".doublebtn2").click(function () {
    ...
    if($(this).css("opacity")=="1"){
        $(this).css({"opacity":"0"})
        if($(this).parent("div").hasClass('twoctrl')){
            $(".funnums2").eq(i+4).addClass("bg-fangzi")
        }else {
            $(".funnums2").eq(i).addClass("bg-fangzi")
        }
    }
})
